...
dag = DAG(
    'bigquery_aggregations_mohammad',
    default_args=default_args,
    schedule_interval=None,
)

dataset_id = 'mohammad'
table_id = 'aggregation_table'
destination_dataset_table = 'tidal-mason-386011.mohammad.aggregation_table'
...
FROM `tidal-mason-386011.qossay_marwn_test.FinalData` where int64_field_2 = 50
GROUP BY month 
ORDER BY month ASC
'''
